...
<body>
	...
	<div class="mt-5 content">
		...
		<div class="m-0 card shadow">
			<form action="{{route('addingSocialPage')}}" method="POST" enctype="multipart/form-data">
				@csrf
				<div class="row p-3">
					...
					<div class="mb-4 col-md-12">
						...
						<input class="form-control" type="text" name="page" id="page" placeholder="Enter a social page" required>
					</div>
